                    ...
                    <div className="mt-auto pt-6 border-t border-[#D4AF37]/10 flex flex-col gap-6">
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex items-center gap-4">
                                <motion.button 
                                    whileTap={{ scale: 0.92 }}
                                    className="flex items-center gap-1.5 text-zinc-400 hover:text-[#D4AF37] transition-colors group/bookmark cursor-pointer"
                                >
                                ...
                                <motion.button 
                                    whileTap={{ scale: 0.92 }}
                                    className="flex items-center gap-1.5 text-zinc-400 hover:text-[#D4AF37] transition-colors cursor-pointer"
                                >
